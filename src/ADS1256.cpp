...
void ADS1256::InitializeADC()
{
  ...
  delay(200);
  writeRegister(ADCON_REG, B00000000); //ADCON - CLK: OFF, SDCS: OFF, PGA = 1
  delay(200);
...
long ADS1256::readSingle() //Reading a single value ONCE using the RDATA command 
{
	...
	delayMicroseconds(5); //Wait t6 time (~1 us for 7.68MHz) REF: P34, FIG:30.
